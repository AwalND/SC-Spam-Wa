...
#
#                       Welcome my SC
#                     Brutal Author By Awal Nurdianto
#         
...
echo ""
echo -e $white"[*] By Awal Nurdianto  "
read enter
exit
}
...
echo -e $BlueF"       \/                         \/                  "$BlueF"   /"
echo -e $BlueF"   | "$cyan"Brutall Created By   "$white": "$red"Awal Nurdianto ( Screetsec )   "$BlueF" /"
echo -e $BlueF"   | "$cyan"Version              "$white": "$red"$version                       "$BlueF" /"
echo -e $BlueF"   | "$cyan"Codename             "$white": "$red"$codename	             "$BlueF" /"
echo -e $BlueF"   | "$cyan"Follow me on Github  "$white": "$red"@AwalND              "$BlueF"/"
